...
(function() {
  ...
  FT("formatting_linkEmail",
     "[link&formatting&formatting-link <][link tbUser@example.com][link&formatting&formatting-link >]");
  ...
  MT("linkEmail",
     "[link <tbUser@example.com>] foo");

  MT("linkEmailDouble",
     "[link <tbUser@example.com>] foo [link <tbUser@example.com>]");
