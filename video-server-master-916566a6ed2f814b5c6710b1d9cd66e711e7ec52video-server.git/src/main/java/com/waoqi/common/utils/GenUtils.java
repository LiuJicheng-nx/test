...
import com.waoqi.common.domain.ColumnDO;
import com.waoqi.common.domain.TableDO;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        tableDO.setComments(StringUtils.trim(table.get("tableComment")));
        //表名转换成Java类名
        ...
        for (Map<String, String> column : columns) {
            ...
            columnDO.setComments(StringUtils.trim(column.get("columnComment")));
            columnDO.setExtra(StringUtils.trim(column.get("extra")));
        ...
        for (String template : templates) {
            ...
            try {
                //添加到zip
                String fn = getFileName(template, tableDO.getClassname(), tableDO.getClassName(), config.getString("package").substring(config.getString("package").lastIndexOf(".") + 1));
               if(fn != null){
                   ...
                   System.out.println("error template:"+template);
               }
